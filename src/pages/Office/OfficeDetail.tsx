...
import { Paper, Typography, List, ListItem, Divider, Button } from '@mui/material';
...
const OfficeDetail = () => {
  ...
  return (
    <Paper style={{ padding: '20px', margin: '20px' }}>
      ...
      <Typography variant="body1">전화번호: {officeDetails.branch_phone_number}</Typography>
      ...
      <List>
        {officeDetails.cars.map(car => (
          ...
          >
            {car.brand} ({car.size}) - {car.availability ? '이용 가능' : '이용 불가'}
          </ListItem>
        ))}
      </List>
    </Paper>
